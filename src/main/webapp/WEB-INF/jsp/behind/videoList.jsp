                ...
                <div class="btn-group">
                    <button type="button" id="speakerName"
                        ...
                        <c:forEach items="${speakerList}" var="speaker">
                            <c:if test="${speaker.id ==speaker_id}">
                                ${speaker.speaker_name}
                            </c:if>
                        </c:forEach>
                        <c:if test="${empty speaker_id}">
                            --请选择老师--
                        </c:if>
                    ...
                    <input type="hidden" name="speaker_id" id="speakerId" value="${speaker_id}"/>
                </div>
                <div class="btn-group">
                    ...
                    <input type="hidden" name="course_id" id="courseId" value="${course_id}"/>
                </div>
